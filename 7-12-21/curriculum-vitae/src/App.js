...
import img from './risorse/img.jpg';
    ...
    <div className="card">
      ...
      <img className="card__img" src={img}/>
        ...
        <Card
          ...
          title="Backpack" content="Tasca più di 15, lo scomparto principale dello zaino scuola per PC può contenere laptop da 15.6 pollici iPad libri raccoglitori cartelle vestiti astuccio e materiale scolastico. Rendi gli accessori organizzati e facili da trovare. "
          color="Colors"
          size="Size"
